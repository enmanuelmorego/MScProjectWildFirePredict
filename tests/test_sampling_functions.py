...
def test_valid_sample_extract_temporal_sample():
    df_fire = pd.DataFrame({"grid_id": [1, 1, 1, 1, 2, 2, 3],
                        ...
                        "composite_key": ["1_20200615",
                                          ...
                                          "2_20201215",
                                          "3_20201215"],
                        "fire_lbl": [False,False,False,False,False,False,False]})
...
def test_exclude_if_used_extract_temporal_sample():
    df_fire = pd.DataFrame({"grid_id": [1, 1, 1, 1, 1, 2, 2, 3],
                            "date": pd.to_datetime(["2020-06-15",  
                                                    "2020-06-20",  
                                                    "2020-06-10",
                                                    "2020-07-01",  
...
def test_non_valid_fire_candidate_sample_extract_temporal_sample():
    df_fire = pd.DataFrame({"grid_id": [1, 1, 1, 1, 2, 2, 3],
                            "date": pd.to_datetime(["2020-06-15",  
                                                    "2020-06-20",  
                                                    "2020-07-01",  
                            ...
                            "composite_key": ["1_20200615",
                                              ...
                                              "2_20201215",
                                              "3_20201215"],
                            "fire_lbl": [True,True,True,False,False,False,False]})
