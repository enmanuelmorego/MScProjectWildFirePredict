...
def test_split_batch_greater_than_limit_even_number_split():
    ...
    # Set expectations
    batch_num_expect = 15
    dict_expect = {"2025_B011_20250102_20250102_sentinel_batch": {'date': [date], 'split_group': [0,5]  },
                   "2025_B012_20250102_20250102_sentinel_batch": {'date': [date], 'split_group': [5,10]  },
                   "2025_B013_20250102_20250102_sentinel_batch": {'date': [date], 'split_group': [10,15]},
                   "2025_B014_20250102_20250102_sentinel_batch": {'date': [date], 'split_group': [15,20]}}
...
def test_split_batch_greater_than_limit_odd_number_split():
    ...
    # Set expectations
    batch_num_expect = 4
    dict_expect = {"2025_B000_20250102_20250102_sentinel_batch": {'date': [date], 'split_group': [0,5]  },
                   "2025_B001_20250102_20250102_sentinel_batch": {'date': [date], 'split_group': [5,10]  },
                   "2025_B002_20250102_20250102_sentinel_batch": {'date': [date], 'split_group': [10,15]},
                   "2025_B003_20250102_20250102_sentinel_batch": {'date': [date], 'split_group': [15,19]}}
    dict_out, new_batch = psent.split_batch_greater_than_limit(date, group_size, batch_size, batch_num)
    assert new_batch    == batch_num_expect
    assert dict_out     == dict_expect
...
def test_sampled_to_batch_within_limit_batches_singledate():
    ...
    dict_test = psent.sampled_to_batch(df, 0, pd.Timestamp(1900, 1, 1))
